  ...
  return (
    ...
    <div className="notification-group">
      ...
      <div className="notification-section">
        ...
        <div className="notification-msg">
            <img src={img3} alt="" />
            <p>Sonu liked <span className='noti-like'>your profile picture</span><br /><small>5h ago</small></p>
        </div>

        <div className="notification-msg">
            <img src={img4} alt="" />
            <p>Nihar liked <span className='noti-like'>your profile picture</span><br /><small>1 min ago</small></p>
        </div>
      </div>
    </div>
    </div>
